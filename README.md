...
Neste projeto foi desenvolvido os testes de uma Pokédex, desenvolvida em React. 

 Neste projeto:

  * Foi utilizado os seletores (queries) da React-Testing-Library em testes automatizados;

  * Simulado eventos com a React-Testing-Library em testes automatizados;

  * Testado fluxos lógicos assíncronos com a React-Testing-Library;

  * Foi escrito testes que permitem a refatoração da estrutura dos componentes da aplicação sem necessidade de serem alterados;
